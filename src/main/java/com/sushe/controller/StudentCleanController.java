...
import com.sushe.po.export.StudentCleanExport;
...
public class StudentCleanController {
    ...
    public String findDormClean(StudentClean studentClean, Model model) {
        model.addAttribute("pageInfo",studentCleanService.findPageInfo(studentClean));
        return "studentclean/studentclean_list";
    }
    ...
    @ResponseBody
    @ExportAs(StudentCleanExport.class)
    ...
    public String findDormCleanById(Integer g_id, HttpSession session) {
        ...
        return "studentclean/studentclean_edit";
    }
}
