...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.sushe.po.Class" %>
...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tbody>
<c:forEach items="${pageInfo.list}" var="ci">
        <tr>
            <td>${ci.c_id}</td>
            <td>${ci.c_classid}</td>
    ...
    <jsp:include page="../page.jsp">
        <jsp:param name="url" value="/findClass"/>
    </jsp:include>
